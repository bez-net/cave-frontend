...
const Financials = ({ fromData, setForm, navigation }) => {
  return (
    ...
    <div className="register__content">
      ...
      <span className="note">
        The RCN Bible Seminary - Adullam, offers a Diploma Program in Theology
        and Ministry.
        <br />
        A training program that is both spiritually imparting and intellectual.
        <br />
        <br />
        ...
        This covers Registration, tuition, Administrative charges and Internet
        Management Fee. <br />
        <br />
        On-Campus program Fees: <strong>$1,000</strong> (per semester) <br />
        This covers Registration, tuition, and Administrative charge. <br />
        <h4>Payment Options</h4>
        Payment can be made once for the entire program, or in two instalments
        at the beginning of each semester. <br />
        <strong>Note:</strong> The exchange rate for Students paying into the
        Naira Account is N400 per Dollar.
        <h4>Provost Scholarship Grants</h4>
        Scholarship grants are made available through the generous donations of
        kind partners. <br />
        ...
        The Scholarship grant is only available upon request for those who truly
        believe that they cannot afford the fees. <br />
        Please note that all Scholarship Grants are subject to availability of
        funds and the decision of the Scholarship Grants Board. <br />
        <br />
        <h4>ACCOMMODATION</h4>
        Note that the school fees does not cover for accommodation. <br />
        There are two Accommodation options for those travelling in to Makurdi.{" "}
        <br />
        <ul>
          <li>
            <h5>Option 1:</h5>
          ...
          range of N80,000 - N150,000 for single room. It is entirely up to the
          students to make the arrangements for themselves. However, Adullam
          Help Desk (+2349014526570) will be glad to support where necessary.
          <li>
            <h5>Option 2:</h5>
          </li>
          There is a shared room space of 4 persons per room within the school
          environment for N30,000 per session (covering for the two semesters).{" "}
          <br />
          <br />
          You may contact the Help Desk on +2349014526570 to make reservations.
        </ul>
      </span>
